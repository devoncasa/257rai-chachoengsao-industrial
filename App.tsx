      ...
      <section id="contact" className="scroll-mt-24 bg-sky-100/60 py-20">
        <div className="w-full lg:w-3/5 mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                {/* Phone & Chat Card */}
                <div className="bg-white p-8 rounded-lg shadow-lg border border-slate-200/50 flex flex-col items-center text-center transform hover:-translate-y-1 hover:shadow-xl transition-all duration-300">
                    ...
                    <h3 className="text-xl font-bold text-slate-800 mb-2">{t.contactPhoneTitle}</h3>
                    <p className="text-2xl font-semibold text-slate-700 tracking-wide">+66 (0)81 851 9922</p>
                    <p className="text-sm text-slate-500 mt-1">{t.contactWeChatNote}</p>
                    <div className="flex space-x-6 mt-6">
                        <a href="tel:+66818519922" aria-label="Call" className="text-slate-500 hover:text-sky-600 transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" viewBox="0 0 20 20" fill="currentColor">
                               <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.518.758a10.024 10.024 0 006.96 6.96l.758-1.518a1 1 0 011.06-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                            </svg>
                        </a>
                        <a href="https://wa.me/66818519922" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="text-slate-500 hover:text-sky-600 transition-colors">
                ...
                <div className="bg-white p-8 rounded-lg shadow-lg border border-slate-200/50 flex flex-col items-center text-center transform hover:-translate-y-1 hover:shadow-xl transition-all duration-300">
                    ...
                    <h3 className="text-xl font-bold text-slate-800 mb-2">{t.contactEmailTitle}</h3>
                    <div className="mt-2">
                        <a href="mailto:k.laohasiri@gmail.com" className="text-lg md:text-xl text-blue-700 hover:text-sky-600 hover:underline transition-colors duration-200 break-all">
